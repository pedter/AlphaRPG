const GLOBALS = {
    ...
    MISSIONS: {
        ...
        14: ["The Black Portal", 'Just after you destroyed the Fortress Core another portal appears, this one black and cold as ice.<br><br>A new story begins.', 30, 1, 10, 15000, 0, "Exotic", 12, 11],
...
var Game = {
    ...
    Armors: [[],
        // 0         1     2      3     4      5
        // UNLOCKED, NAME, CLASS, LIFE, LEVEL, GEMS
    ...
    Location: 0,
    PlayTime: 0,
    MissionStarted: [false, 0, 0, 0, 0], // STARTED, MISSION ID, PROGRESSION, OBTAINED REWARD, LOCK WIN
